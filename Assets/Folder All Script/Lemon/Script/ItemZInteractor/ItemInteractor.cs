...
public class ItemInteractor : MonoBehaviour,IInteractable
{
    ...
    // Add at bottom of your script

// Expose state for testing
public bool IsHeld() => isHeld;

// Allow tests to trigger pickup without interface cast
public void Test_PickUp(Transform interactor)
{
    PickUp(interactor);
}

// Allow tests to trigger place without Input
public void Test_Place()
{
    Place();
}

// Optional: isolate input (BEST PRACTICE)
